  ...
  return (
    <section className="py-16 md:py-24 bg-paper overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
        <TourRow title="Asia" accent="best sellers" subtitle="Tropical beaches, ancient cities, vibrant markets." data={asiaTours} />
        <TourRow title="Middle East" accent="& beyond" subtitle="Desert luxury, modern skylines, ancient wonders." data={middleEastTours} />
      </div>
    </section>
  );
};
